            ...
            <div class="card card-primary">
              ...
              <?php
                ...
                <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="jenis_berita"  name="jenis_berita" placeholder="Masukkan jenis berita"  >
                ...
                <div class="form-group">
                    ...
                    <textarea type="text"  rows="10" class="form-control" id="keterangan"  name="keterangan" placeholder="keterangan" ></textarea>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <img src="<?=base_url('/assets/gambar_konfigurasi/nofoto.jpg')?>" id="gambar_load"  width="90px" height="120px">
                      </div>
                    </div> 
                </div> 
