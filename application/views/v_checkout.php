    ...
    <div class="col-sm-8 invoice-col">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="nama_pelanggan" class="form-control" placeholder="Nama Lengkap" value="<?php echo $pelanggan->nama_pelanggan ?>" required>            </div> 
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                <label>Nomer Telepon</label>
                <input type="text" name="no_telepon" class="form-control" placeholder="Telepon" value="<?php echo $pelanggan->no_telepon ?>" required>
            </div> 
        </div>
