     ...
     <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_produk"  name="nama_produk"  placeholder="Masukkan nama produk" value="<?= set_value('nama_produk')?>" >
    ...
    <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" id="keterangan"  name="keterangan" placeholder="deskripsikan produk anda" ><?= set_value('keterangan')?> </textarea>
